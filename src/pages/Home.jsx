...
import { PHONE_DISPLAY, EMAIL_DISPLAY, SITE_URL } from '../config'
...
export default function Home() {
  return (
    <>
      <SEO
        description={`Dumpster and dump trailer rentals across Central Iowa. Fast delivery for roofing, construction, garage cleanouts, and demolition. Call ${PHONE_DISPLAY} today.`}
        path="/"
